...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, root, data_info, img_size=416, batch_size=16, 
        ...
        for ix in data_info:
            self.img_files.append(os.path.join(self.root, data_info[ix]['imgpth']))
            self.label_files.append(os.path.join(self.root, data_info[ix]['lbpth']))
        ...
        self.imgs, self.labels = [None] * n, [None] * n
        '''
        self.imgs = [None] * n
        self.labels = [None] * n
